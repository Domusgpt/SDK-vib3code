...
class ReactiveInputs {
    constructor() {
        ...
        this.smoothing = 0.25;
        this.lookahead = new LookaheadBuffer({ lookaheadMs: 200 });
    }
    ...
    sample() {
        ...
        this.lookahead.pushFrame(smoothed, energy);

        const projected = this.lookahead.getProjectedFrame();
        if (projected) {
            this.state.bands = projected.bands;
            this.state.energy = projected.energy;
        } else {
