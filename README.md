...
- Export automation packs into asset manifests (states, transitions, control coverage) for downstream agent packs or galleries: `pnpm telemetry:export-pack -- path/to/automation-pack.json my-pack automation-export.json`.
